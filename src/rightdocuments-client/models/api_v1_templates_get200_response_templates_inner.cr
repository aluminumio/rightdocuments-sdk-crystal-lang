...
module RightDocuments
  class ApiV1TemplatesGet200ResponseTemplatesInner
    ...
    def initialize(@id : String, @name : String, @description : String?, @tags : Array(String)?)
    end
