...
module RightDocuments
  class ApiV1EntitiesPostRequestEntity
    ...
    def valid?
      entity_type_validator = EnumAttributeValidator.new("String", ["c-corp", "s-corp", "llc", "partnership"])
      return false unless entity_type_validator.valid?(@entity_type)
      formation_state_validator = EnumAttributeValidator.new("String", ["CA", "DE"])
      return false unless formation_state_validator.valid?(@formation_state)
      status_validator = EnumAttributeValidator.new("String", ["unformed", "incorporation_filed", "incorporation_certified", "operating", "dissolution_filed", "dissolution_certified"])
    ...
    def entity_type=(entity_type)
      validator = EnumAttributeValidator.new("String", ["c-corp", "s-corp", "llc", "partnership"])
    ...
    def formation_state=(formation_state)
      validator = EnumAttributeValidator.new("String", ["CA", "DE"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new("String", ["unformed", "incorporation_filed", "incorporation_certified", "operating", "dissolution_filed", "dissolution_certified"])
    ...
    def _deserialize(type, value)
      ...
      when /\AHash<(?<k_type>.+?), (?<v_type>.+)>\z/
        ...
        klass = RightDocuments.const_get(type)
