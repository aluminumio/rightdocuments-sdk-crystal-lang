...
module RightDocuments
  class ApiV1EntitiesGet200ResponseEntitiesInner
    ...
    # Optional properties
    @[JSON::Field(key: "formation_date", type: String?, nillable: true, emit_null: false)]
    property formation_date : String?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : String, @name : String, @entity_type : String, @state : String, @status : String, @formation_date : String?)
    end
    ...
    def hash
      [id, name, entity_type, state, status, formation_date].hash
    end
